...
require_once 'ejercicio25validar.php'; //Importamos el archivo con las validaciones (requerido, y lo carga unavez).
...
<body>
    ...
    <?php endif; ?>
    <form method="post" action="ejercicio25indice.php" enctype="multipart/form-data">
